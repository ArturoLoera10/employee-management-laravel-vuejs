...
class EmployeeController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Employess/Index', ['employees' => $employees, 'departments' => $departments]);
    }
    ...
    public function EmployeeByDepartment()
    {
        ...
        return Inertia::render('Employess/Graphic', ['data' => $data]);
    }
    ...
    public function reports()
    {
        ...
        return Inertia::render('Employess/Reports', ['employees' => $employees, 'departments' => $departments]);
    }
}
